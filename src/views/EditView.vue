        ...
        <div class="bg-yellow-100 rounded-lg p-4 shadow-inner">
          <div class="space-y-4">
            ...
            <div class="flex items-center gap-4 mt-4">
              ...
              <button
                class="text-white bg-blue-500 border border-blue-500 p-2 rounded-lg hover:bg-blue-600 transition-all"
                @click="editDevice">
                Edit
              </button>
              <button class="text-white bg-red-500 border border-red-500 p-2 rounded-lg hover:bg-red-600 transition-all"
                @click="removeDevice">
                Delete
              </button>
            </div>
